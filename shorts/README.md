...
1. **Discovers** trending YouTube + TikTok content across DE / EN-US /
   ES / IN markets several times per day.
...
See [`ROADMAP.md`](ROADMAP.md) for what's coming next (long-form
companion when a short pops, rising-trend discovery, TikTok direct
upload).
